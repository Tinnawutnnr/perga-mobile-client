...
const LoadingCard = () => (
  <ThemedView style={styles.stateCard} lightColor="#F8F9FA" darkColor="#1A1A1A">
...
const ErrorCard = ({
  ...
  return (
    <ThemedView style={styles.stateCard} lightColor="#F8F9FA" darkColor="#1A1A1A">
      ...
      <ThemedText style={{ fontSize: 13, color: mutedColor, marginTop: 8, textAlign: "center" }}>
        {message}
      </ThemedText>
...
const MetricCompareScreen = () => {
  ...
  const screenTitle = metricInfo?.display_name ?? "Compare";
...
export default MetricCompareScreen;
