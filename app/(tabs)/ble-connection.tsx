  ...
  const renderDevice = ({ item }: { item: BluetoothDeviceDisplay }) => {
    ...
    return (
      <TouchableOpacity
        ...
        onPress={() =>
          isConnected ? disconnectDevice() : connectToDevice(item.rawDevice)
        }
        activeOpacity={0.7}
      >
        <ThemedView transparent style={styles.deviceInfo}>
          <ThemedView transparent style={styles.deviceHeader}>
            ...
            <ThemedView transparent style={styles.deviceDetails}>
              ...
              <ThemedText type="muted" style={styles.deviceId}>
                ID: {item.id}
              </ThemedText>
            </ThemedView>
      ...
      >
        ...
        <ThemedView style={styles.section}>
          <ThemedView style={styles.sectionHeader}>
            ...
            {isScanning && (
              <ThemedText style={{ color: tintColor }}>Scanning...</ThemedText>
            )}
          </ThemedView>
